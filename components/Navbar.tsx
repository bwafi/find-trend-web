...
export default function Navbar() {
  ...
  return (
    <nav
      ...
      <div
        className={`flex items-center lg:justify-between lg:space-y-0 space-y-8 lg:10/12 w-full flex-wrap lg:flex-nowrap absolute lg:static bg-black lg:bg-transparent lg:ml-32 left-0 lg:pt-0 pt-20 top-16 h-screen lg:h-auto flex-col lg:flex-row transition-transform duration-500 lg:-translate-x-0 ${
        ...
        <div className="flex space-y-8 lg:space-y-0 items-center font-efrra lg:space-x-7 lg:w-3/12 flex-wrap lg:flex-nowrap justify-center flex-col lg:flex-row">
          <button className="text-lg py-1 px-6 rounded-full transition-all duration-300 ease-in-out hover:border hover:border-green">
            Login
          </button>
